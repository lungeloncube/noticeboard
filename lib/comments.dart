...
class Comments extends StatefulWidget {
  ...
  const Comments({Key key, @required this.firstName, @required this.lastName, @required this.date, @required this.url, @required this.post, @required this.media}) : super(key: key);
...
class _CommentsState extends State<Comments> {
  ...
  List<User> users=[ User(firstName: "Lungelo", lastName: "Ncube", url: "assets/one.jpg",date:"Monday July 9, 12:15pm", post:"lorem ipsum ", media:"assets/post_image.jpg" ),
    User(firstName: "Stalker", lastName: "Stalker", url: "assets/two.jpg",date:"Monday July 9, 12:15pm",post:"lorem ipsum " , media:"assets/post_image.jpg"),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(appBar:AppBar(title:Text("Comments")),
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(children: [
              ...
              SizedBox(height:15),
              Container(
                  width:width,child: Image.asset(widget.media,fit: BoxFit.fill,)),
              SizedBox(height:15),
            ],),
          ),
  ...
  Widget _buildFeed(width){
    return Container(
      child: ListView.builder(physics: const NeverScrollableScrollPhysics(),
          shrinkWrap: true,itemCount:users.length,itemBuilder: (context, index){
                        ...
                        children: [
                          Container(
                            padding: const EdgeInsets.fromLTRB(8, 0, 0, 8),
                              color: Colors.grey[300],child:Column(children: [
                            Row(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              IconButton(icon: Icon(isLiked?Icons.thumb_up:Icons.thumb_up_alt_outlined, color:Colors.blue), onPressed: (){
                                setState(() {
                                  isLiked=!isLiked;
                                });
                              }),
                        IconButton(icon:Icon(Icons.reply, color: Colors.blue), onPressed: (){
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => CommentReply(user: users[index],),
                            ),
                          );
                          setState(() {
                            isCommentReply=true;
